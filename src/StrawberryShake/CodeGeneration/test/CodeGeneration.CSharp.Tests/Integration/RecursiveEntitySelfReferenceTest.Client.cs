...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class RecursiveEntitySelfReferenceClientServiceCollectionExtensions
    {
        public static global::StrawberryShake.IClientBuilder<global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.RecursiveEntitySelfReferenceClientStoreAccessor> AddRecursiveEntitySelfReferenceClient(this global::Microsoft.Extensions.DependencyInjection.IServiceCollection services, global::StrawberryShake.ExecutionStrategy strategy = global::StrawberryShake.ExecutionStrategy.NetworkOnly)
        {
            ...
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton(services, sp => global::Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.IGetSelfishGuyQuery>(global::Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<ClientServiceProvider>(sp)));
        ...
        private static global::Microsoft.Extensions.DependencyInjection.IServiceCollection ConfigureClientDefault(global::System.IServiceProvider parentServices, global::Microsoft.Extensions.DependencyInjection.ServiceCollection services, global::StrawberryShake.ExecutionStrategy strategy = global::StrawberryShake.ExecutionStrategy.NetworkOnly)
        {
            ...
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::StrawberryShake.Transport.InMemory.IInMemoryConnection>(services, sp =>
            {
                ...
                return new global::StrawberryShake.Transport.InMemory.InMemoryConnection(async ct => await clientFactory.CreateAsync("RecursiveEntitySelfReferenceClient", ct));
            });
...
namespace StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference
{
    ...
    {
        public GetSelfishGuy_SelfishGuy_Person(global::System.String id, global::System.String firstName, global::System.String lastName, global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.IGetSelfishGuy_SelfishGuy_BestFriend? bestFriend)
        {
            Id = id;
            FirstName = firstName;
            LastName = lastName;
        ...
        public virtual global::System.Boolean Equals(GetSelfishGuy_SelfishGuy_Person? other)
        {
            ...
            return (Id.Equals(other.Id)) && FirstName.Equals(other.FirstName) && LastName.Equals(other.LastName) && ((BestFriend is null && other.BestFriend is null) || BestFriend != null && BestFriend.Equals(other.BestFriend));
        }
    ...
    {
        public GetSelfishGuy_SelfishGuy_BestFriend_Person(global::System.String firstName, global::System.Int32 age, global::System.String phone)
        {
            FirstName = firstName;
            Age = age;
            Phone = phone;
        ...
        public virtual global::System.Boolean Equals(GetSelfishGuy_SelfishGuy_BestFriend_Person? other)
        {
            ...
            return (FirstName.Equals(other.FirstName)) && global::System.Object.Equals(Age, other.Age) && Phone.Equals(other.Phone);
        }
    ...
    public partial class GetSelfishGuyQueryDocument : global::StrawberryShake.IDocument
    {
        ...
        public global::System.ReadOnlySpan<global::System.Byte> Body => "query GetSelfishGuy { selfishGuy { __typename id firstName lastName bestFriend { __typename firstName age phone ... on Person { id } } ... on Person { id } } }"u8;
        public global::StrawberryShake.DocumentHash Hash { get; } = new global::StrawberryShake.DocumentHash("sha1Hash", "81e08beba7005d9d50ad6cf52ef325aa054f30b9");
...
namespace StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State
{
    ...
    {
        public PersonEntity(global::System.String id = default !, global::System.String firstName = default !, global::System.String lastName = default !, global::StrawberryShake.EntityId? bestFriend = default !, global::System.Int32 age = default !, global::System.String phone = default !)
        {
            Id = id;
            FirstName = firstName;
            LastName = lastName;
    ...
    public partial class GetSelfishGuyBuilder : global::StrawberryShake.OperationResultBuilder<global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.IGetSelfishGuyResult>
    {
        ...
        private global::StrawberryShake.EntityId Update_NonNullableIGetSelfishGuy_SelfishGuyEntity(global::StrawberryShake.IEntityStoreUpdateSession session, global::System.Text.Json.JsonElement? obj, global::System.Collections.Generic.ISet<global::StrawberryShake.EntityId> entityIds)
        {
            ...
            if (entityId.Name.Equals("Person", global::System.StringComparison.Ordinal))
            {
                if (session.CurrentSnapshot.TryGetEntity(entityId, out global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.PersonEntity? entity))
                {
                    ...
                    var arg3 = Update_IGetSelfishGuy_SelfishGuy_BestFriendEntity(session, global::StrawberryShake.Json.JsonElementExtensions.GetPropertyOrNull(obj, "bestFriend"), entityIds);
                    session.SetEntity(entityId, new global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.PersonEntity(arg0, arg1, arg2, arg3, entity.Age, entity.Phone));
                }
                else
                {
                    var arg0 = Deserialize_NonNullableString(global::StrawberryShake.Json.JsonElementExtensions.GetPropertyOrNull(obj, "id"));
                    ...
                    {
                        session.SetEntity(entityId, new global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.PersonEntity(arg0, arg1, arg2, arg3, default !, default !));
                    }
                }
        ...
        private global::StrawberryShake.EntityId? Update_IGetSelfishGuy_SelfishGuy_BestFriendEntity(global::StrawberryShake.IEntityStoreUpdateSession session, global::System.Text.Json.JsonElement? obj, global::System.Collections.Generic.ISet<global::StrawberryShake.EntityId> entityIds)
        {
            if (!obj.HasValue)
            {
                return null;
            ...
            if (entityId.Name.Equals("Person", global::System.StringComparison.Ordinal))
            {
                if (session.CurrentSnapshot.TryGetEntity(entityId, out global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.PersonEntity? entity))
                {
                    ...
                    var arg1 = Deserialize_NonNullableInt32(global::StrawberryShake.Json.JsonElementExtensions.GetPropertyOrNull(obj, "age"));
                    var arg2 = Deserialize_NonNullableString(global::StrawberryShake.Json.JsonElementExtensions.GetPropertyOrNull(obj, "phone"));
                    session.SetEntity(entityId, new global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.PersonEntity(entity.Id, arg0, entity.LastName, entity.BestFriend, arg1, arg2));
                }
                else
                {
                    var arg0 = Deserialize_NonNullableString(global::StrawberryShake.Json.JsonElementExtensions.GetPropertyOrNull(obj, "firstName"));
                    ...
                    {
                        session.SetEntity(entityId, new global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.PersonEntity(default !, arg0, default !, default !, arg1, arg2));
                    }
                }
    ...
    public partial class GetSelfishGuy_SelfishGuy_PersonFromPersonEntityMapper : global::StrawberryShake.IEntityMapper<global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.PersonEntity, GetSelfishGuy_SelfishGuy_Person>
    {
        ...
        public GetSelfishGuy_SelfishGuy_Person Map(global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.PersonEntity entity, global::StrawberryShake.IEntityStoreSnapshot? snapshot = null)
        {
            ...
            return new GetSelfishGuy_SelfishGuy_Person(entity.Id, entity.FirstName, entity.LastName, MapIGetSelfishGuy_SelfishGuy_BestFriend(entity.BestFriend, snapshot));
        }

        private global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.IGetSelfishGuy_SelfishGuy_BestFriend? MapIGetSelfishGuy_SelfishGuy_BestFriend(global::StrawberryShake.EntityId? entityId, global::StrawberryShake.IEntityStoreSnapshot snapshot)
        {
            if (entityId is null)
            {
                return null;
            ...
            {
                return _getSelfishGuy_SelfishGuy_BestFriend_PersonFromPersonEntityMapper.Map(snapshot.GetEntity<global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.PersonEntity>(entityId.Value) ?? throw new global::StrawberryShake.GraphQLClientException());
            }
    ...
    public partial class GetSelfishGuy_SelfishGuy_BestFriend_PersonFromPersonEntityMapper : global::StrawberryShake.IEntityMapper<global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.PersonEntity, GetSelfishGuy_SelfishGuy_BestFriend_Person>
    {
        ...
        public GetSelfishGuy_SelfishGuy_BestFriend_Person Map(global::StrawberryShake.CodeGeneration.CSharp.Integration.RecursiveEntitySelfReference.State.PersonEntity entity, global::StrawberryShake.IEntityStoreSnapshot? snapshot = null)
        {
            ...
            return new GetSelfishGuy_SelfishGuy_BestFriend_Person(entity.FirstName, entity.Age, entity.Phone);
        }
    }
